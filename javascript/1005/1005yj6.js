...
- null은 존재하지만 값이나 객체가 할당되지 않았음을 의미하는 특수한 값인 반면,  undefined는 애초에 존재(정의)하지 않거나 초기화 하지 않음을 의미. 따라서 객체간 비교 또는 값의 할당 여부를 확인하기위한 비교 연산시, 이퀄(equal : '==')연산인지 또는 엄격 이퀄(strict equal : '===')연산인지에 따라 그 평과 결과가 달라질 수 있음에 주의.
